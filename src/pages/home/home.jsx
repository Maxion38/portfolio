  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.row}>
        ...
        <button onClick={() => setActiveTab("stage")} className={glassStyles.glassButton} style={{ width: "30%", height: '45%', display: 'flex', flexDirection: 'column', gap: '15px'}}>2. Mon stage à la BLG <div className={styles.go}>Stage <BsArrowRight fontSize={"2.2rem"} /></div></button>
